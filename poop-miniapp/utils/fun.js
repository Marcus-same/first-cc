...
function celebrate(type) {
  // Use vibration for celebrations since we don't have audio files
  switch (type) {
    case 'achievement':
      wx.vibrateLong();
...
module.exports = { PERSONAS, getPersonality, getFortune, getMilestone, celebrate };
